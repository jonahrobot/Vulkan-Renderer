...
namespace game {
	...
	void Camera::SetPosition(glm::vec3 taget_position) {
		position = taget_position;
	}

	void Camera::ObserverUpdate(float a, float b){
		render_width = a;
		render_height = b;
	}

	void Camera::MoveCamera(GLFWwindow* window, float delta_time, bool use_keyboard, bool use_mouse) {
